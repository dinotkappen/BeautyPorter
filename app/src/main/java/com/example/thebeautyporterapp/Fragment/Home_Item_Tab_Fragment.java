...
import com.example.thebeautyporterapp.Adapter.Main_Menu_Adapter;
...
public class Home_Item_Tab_Fragment extends Fragment {
    ...
    List<Service_List_Model> dataArray = new ArrayList<>();

    public Home_Item_Tab_Fragment(List<Service_List_Model> dataArray1) {
...
//        if (dataArray.size()!=0)
//        Log.e("array_value",""+dataArray.size());
