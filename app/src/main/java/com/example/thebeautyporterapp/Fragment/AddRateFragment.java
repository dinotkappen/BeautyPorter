...
View rootView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView= inflater.inflate(R.layout.fragment_add_rate, container, false);

        imgMenu.setVisibility(View.GONE);
        backArrow.setVisibility(View.VISIBLE);
        txt_actionbar_Title.setVisibility(View.VISIBLE);
        txt_actionbar_Title.setText("Feedback");
        ...
        btnSenReview = (Button) rootView.findViewById(R.id.btnCommon);
        ...
        btnSenReview.setBackgroundResource(R.color.colorBoldText);
...
//                                    dialog.show();
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("business", selectedBusinessID);
