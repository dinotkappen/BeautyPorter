...
public class PrivacyPolicyFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        txt_actionbar_Title.setText(getString(R.string.Privacy_Policy ));
...
//        myWebView.loadUrl("https://www.thebeautyporter.net/register/4");
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            txtContent.setText(Html.fromHtml("<h1>Privacy Policy</h1>\n" +
                    "\n" +
                    "\n" +
                    "<p>Effective date: September 27, 2018</p>\n" +
                    "\n" +
                    "\n" +
                    "<p>The Beauty Porter (\"us\", \"we\", or \"our\") operates the  website and the 1234567890 mobile application (the \"Service\").</p>\n" +
                    "\n" +
                    "<p>This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data. Our Privacy Policy  for The Beauty Porter is managed through <a href=\"https://www.freeprivacypolicy.com/free-privacy-policy-generator.php\">Free Privacy Policy</a>.</p>\n" +
                    "\n" +
                    ...
                    "<h2>Use of Data</h2>\n" +
                    "   \n" +
                    "<p>The Beauty Porter uses the collected data for various purposes:</p>   \n" +
                    "<ul>\n" +
                    ...
                    "<p>If you are located outside Qatar and choose to provide information to us, please note that we transfer the data, including Personal Data, to Qatar and process it there.</p>\n" +
                    "<p>Your consent to this Privacy Policy followed by your submission of such information represents your agreement to that transfer.</p>\n" +
                    "<p>The Beauty Porter will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>\n" +
                    "\n" +
                    "<h2>Disclosure Of Data</h2>\n" +
                    "\n" +
                    "<h3>Legal Requirements</h3>\n" +
                    "<p>The Beauty Porter may disclose your Personal Data in the good faith belief that such action is necessary to:</p>\n" +
                    "<ul>\n" +
                    "    <li>To comply with a legal obligation</li>\n" +
                    "    <li>To protect and defend the rights or property of The Beauty Porter</li>\n" +
                    ...
                    "<ul>\n" +
                    "        <li>By email: info@thebeautyporter.net</li>\n" +
                    "         \n" +
